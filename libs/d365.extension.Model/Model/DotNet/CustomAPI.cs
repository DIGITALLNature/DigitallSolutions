...
namespace D365.Extension.Model
{
	...
	public partial class CustomAPI : Entity, INotifyPropertyChanging, INotifyPropertyChanged
    {
		...
		/// <summary>
		/// 1:N dgt_carrier_constraint_customapi_id_customapi
		/// </summary>	
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("dgt_carrier_constraint_customapi_id_customapi")]
		public System.Collections.Generic.IEnumerable<DgtCarrierConstraint> DgtCarrierConstraintCustomapiIdCustomapi
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<DgtCarrierConstraint>("dgt_carrier_constraint_customapi_id_customapi", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("DgtCarrierConstraintCustomapiIdCustomapi");
				this.SetRelatedEntities<DgtCarrierConstraint>("dgt_carrier_constraint_customapi_id_customapi", null, value);
				this.OnPropertyChanged("DgtCarrierConstraintCustomapiIdCustomapi");
			}
		}
